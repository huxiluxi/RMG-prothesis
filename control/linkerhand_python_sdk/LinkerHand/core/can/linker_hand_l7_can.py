...
class LinkerHandL7Can:
    ...
    def set_joint_positions(self, joint_angles):
        """Set the positions of 7 joints (joint_angles: list of 10 values)."""
        self.is_lock = True
    ...
    def get_touch(self):
        '''Get touch data'''
        self.send_frame(0xb1,[],sleep=0.01)
        self.send_frame(0xb2,[],sleep=0.01)
        self.send_frame(0xb3,[],sleep=0.01)
        self.send_frame(0xb4,[],sleep=0.01)
        self.send_frame(0xb5,[],sleep=0.01)
